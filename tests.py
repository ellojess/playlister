...
class PlaylistsTests(TestCase):
    ...
    # send in a PUT message with a change and see if it response with a 200
    ...
    # test deleting a playlist: create the sample playlist, then send in a delete message to see if we can destroy it and get a 302 status back
